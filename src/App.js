...
class App extends Component {
  ...
  render() {
    ...
    {
        label: 'Billing and tariff issues',
        value: 30,
        parent: 'TEST',
      ...
      {
          label: 'Still receiving estimated bills / inaccurate bills',
          value: 4,
          parent: 'Drama',
      ...
      {
          label: 'Providing inaccurate information / sales practices',
          value: 8.8,
          parent: 'Crime',
    ...
    return (
      <div className="App">
         <JqxTreeMap
                width={'80%'} height={400} colorRange={50}
                source={data} renderCallbacks={renderCallbacks}
          />
      </div>
    );
  }
